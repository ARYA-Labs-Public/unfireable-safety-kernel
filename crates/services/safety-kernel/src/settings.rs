...
pub struct Settings {
    ...
    /// `env`). Step-14R / internal-ref: lets prod fetch the seed from a
...
impl Settings {
    ...
    pub fn from_env() -> Result<Self> {
        ...
        // prod gates). Hardening for purple-team finding PT-1 (internal-ref).
        ...
        // ── Signing-key backend (Step-14R / internal-ref Phase-4) ──────
